...
public class ProjectitApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat3 = new Categoria(null, "Categoria nova 3");
		Categoria cat4 = new Categoria(null, "Categoria nova 4");
		Categoria cat5 = new Categoria(null, "Categoria nova 5");
		Categoria cat6 = new Categoria(null, "Categoria nova 6");
		Categoria cat7 = new Categoria(null, "Categoria nova 7");
		Categoria cat8 = new Categoria(null, "Categoria nova 8");
